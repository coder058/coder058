...
This trades apparent completeness for data integrity. Closed candles can also be
persisted to PostgreSQL locally and in CI; the public Vercel demo does not serve
that database.
